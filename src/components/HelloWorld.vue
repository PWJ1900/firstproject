      ...
      <el-header
        ...
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="lookusername()"
              >更改信息</el-dropdown-item
            >
            <el-dropdown-item @click.native="addFormstate = true"
              >新增</el-dropdown-item
            >
          </el-dropdown-menu>
        </el-dropdown>
          ...
          >
            <el-submenu index="1">
              <template slot="title"
                ...
                ><span>后台管理系统</span></template
              >
              <el-menu-item-group style="background-color: rgb(48, 65, 86)">
                <el-menu-item index="1-1" @click="change" style="color: #aab2c3"
                  ><span>信息预览</span></el-menu-item
                >
              </el-menu-item-group>
            </el-submenu>
            <el-submenu index="1">
              <template slot="title"
                ><i class="el-icon-menu"></i><span>更改信息</span></template
              >
              <el-menu-item-group style="background-color: rgb(48, 65, 86)">
                <el-menu-item
                  index="2-1"
                ...
                <el-menu-item
                  index="2-6"
                  @click="People_detail_simples"
                  style="color: #aab2c3"
                  >个人详情简介</el-menu-item
                >
                <el-menu-item
                  index="2-7"
                  @click="People_educations"
                  style="color: #aab2c3"
                  >个人文化水平</el-menu-item
                >
                <el-menu-item
...
export default {
  ...
  methods: {
    ...
    userAdd() {
      ...
      tran["num"] = 3;
      this.$http.post("http://127.0.0.1:8000/blog/gerloginper", tran).then(
        (response) => {
